...
QT_MOC_LITERAL(2, 31, 0) // ""
    ...
    "Eliminar\0on_pushButton_clicked\0"
};
...
void Eliminar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Eliminar *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Eliminar::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_Eliminar.data,
    qt_meta_data_Eliminar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
